gtkwave::addSignalsFromList {
  ...
  tb_riscv_top.dut.pc_stall
  tb_riscv_top.dut.fwd_a
  tb_riscv_top.dut.fwd_b
...
gtkwave::setWindowEndTime 330
gtkwave::setZoomFactor -1
gtkwave::hardcopy /project/RISCV-Gen/docs/screenshots/hazard_test.png png
exit
